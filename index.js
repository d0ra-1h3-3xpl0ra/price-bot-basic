...
// WEB3 CONFIG, connect to BLOCKCHAIN via RPC 
const web3 = new Web3(new HDWalletProvider(process.env.PRIVATE_KEY, process.env.RPC_URL) )

// Ropsten DAI, TB changed for mainnet implementation!
...
// TB changed for mainnet implementation
...
// Minimum eth to swap
// Add logic here for FL and Slippage Projection 
// Here it's hard coded, use rather dynamic value 
// Add Chai tests before execution
const ETH_AMOUNT = web3.utils.toWei('0.1', 'Ether')
console.log("Eth Amount", ETH_AMOUNT)

// Set Selling Price of ETH 
// Selling Trigger! relation to our ETH_AMOUNT var
const ETH_SELL_PRICE = web3.utils.toWei('320.422074895274387998', 'Ether') // 200 Dai a.k.a. $200 USD
...
async function sellEth(ethAmount, daiAmount) {
  ...
  // Transaction Settings
    // set gasLimit & Price
    // Our origin Account where we provided a private key
    // Change GWEI Price, far to high for MAINNET!
  const SETTINGS = {
  ...
  // Perform Swap
    // .ethToTokenSwapInput function sells our ETH for DAI 
    // DEADLINE is required by UniSwap and set so 60 Secs ATM
    //  SETTINGS 
...
async function monitorPrice() {
  ...
  try {
    ...
    // Check Eth Price 
    // Checks ETH Price based on our provided Exchange 
    ...
    if(price <= ETH_SELL_PRICE) {
      ...
      // Also can prevent selling off our profit 
      // Bot stips running then / theoretical stopp loss 
